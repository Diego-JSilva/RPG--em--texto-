...
public static int menu(){  //função que ira da opções ao jogador
        int opcaomenu;
        do{
...
public static void creditos (int opcaomenu) {   // os desenvolvedores
      ...
      System.out.println(" Diego de Jesus da Silva");
...
do {
    ...
    System.out.println(" Quais são as principais teorias da adiministração ?");
...
"                                                  ##########################@@MMmm++++++mmmmMM@@##@@@@MMMM                                  \n" +
"                                              ++MM@@########################MMmm::::::mmmmMMMM@@##@@MMMMMMmm                                \n" +
"                                            --mm@@@@##################@@@@MMmm++::::::++MMmmMM@@##MM@@MMMMMMMM                              \n" +
"                                          --++mmMM@@####@@@@##@@@@@@MMMMMMMMmm++++::++++MMMM@@####MMMMMMmmMMMM++                            \n" +
"                                        ::--++++MM@@####@@MM@@MMMMMMMMMMMMMMMMmm++++++mmmmMM@@####mmmmMMmmmmMMMM::--                        \n" +
"                                      ------mmmm@@######MMMMMM@@@@MMMMMMMMMMMMmm++++++mmMMMMMM@@##++++mmmmmmMMMM++::++                      \n" +
"                                      ..--::++MM@@####@@@@MMMMMM@@@@@@MMMMMMMMmm++mmmmmmMMMMMM@@@@++++++mmmm++mm++mmmm++--                  \n" +
"                                    ++----::++@@######MM@@MMmmMM@@@@@@MMMMMMMMmmmmmmmmmmMMMMMM@@MM::::::++mmmm::--++::::::++                \n" +
"                                  mm--..--::MMmm####MMmm@@MMmmmmMM@@@@MMMMMMmm++mmmmmmmmmmMMMM@@MM::::::::::++++::mm--::--::++::            \n" +
"                              ::::::......--++@@##@@mmmmMMMMMMmmMM@@MMMMMMMMmm++::mmmmmmmmmmmmMM++--::++::::::::--mm--::....--::++--        \n" +
"                            --++--..........++####MMmm++mmmmMMMMMM@@@@@@@@MMmm++++++mmmmmmmmmmMM++mm::::::--++++--mm--::--..    ..----mm    \n" +
"                        ..----mm--..........++@@##mm++::++mmmmmmMM@@@@@@@@MMmm++++mmmm++++::::MM--mm--++::----::..++--::::----..--....::++++\n" +
"                      ----..------....    --@@@@@@++::--::::++mmmm@@MMMM@@MM++++++mm++::::::::::####..::--::::----::------------..--....::::\n" +
"                    --::--..::----..  ....::##MM@@::::--..--::++mmMMMMmmMMMM++++++++::::----::MM########MM----....--  ----..----------------\n" +
"                --::::::--..++..--    ..@@@@MMMM##::::--....----mmmmMM++++mm++++++++::----::mm##############..  ..--  --..--....--..----::++\n" +
"              ::::::----....mm....  --mm@@++mm++@@::--::::--..  ++mmmm----::++++::------------################....::  ..--..----..--....::--\n" +
"            mm----::::......++......--++++mm++mmMM::----------++++++++..--::++++::----------::@@@@@@mmmmmm@@@@##::--  ....----....--....----\n" +
"          ++++------::......++......--::  ++++mmmm----------::::++++++++--++++::::::--....++::mmmmMM::::......::MM::..........  ....--......\n" +
...
"MM::------------..++::--..::::................--..--++++mm++----::++++--::++::++mm--..##@@mm--....            ......--..  ..----::::::++--::\n" +
"mm::--......----..++mm..--..::--..      ........::..--++--++++--::++++--++++::mm++--####mm::....              ..  --..    ------::::--::::::\n" +
"MMmm::..--------  ::::--....--::--..  ......  ..::..--++++++++++::mmmm++++mmmmMM++mm##MM++--..            ..  ....  ..    ..----::::::--::--\n" +
"::++--......::--....--::......::--..............--....::mm::::++mmmmmmmm++mmmmMM--@@@@++::----            ..  ......      ------::::++++++::\n" +
"::::::----..::..--..::++--....----..........  ..--::..--mm++++mmMMMMmm++::mmmm++@@@@++::::--          ..  ..........  ....--::::--++::++::++\n" +
"::..----------++::--++::--..------..............--::....--::mm++mmMMMMmm++mmMM++@@MM::++::....              ..............::::::::++++mm::++\n" +
"::mm##MM::--::::::--::++::....------....    ......::..----::++MMMMMM@@MMMMmmMMmmMMmm++------          ..  ..--............::--::++mm::++MM++\n" +
"++::++@@@@@@##::++::--++::....------......  ..  ------..----..mm@@MM##MMMMmm++@@++mm++::----....        ....--  ......----::::++::++MM++::++\n" +
...
"MMmmMM@@::::++mmmmmmmm++++::----++------....--..------------------::++++@@::@@mmmm++::::--::..----..----::::..----..--::::::++::::mm++++++::\n");
      ...
      static void taberna1(int walk, String resp01tb) {
                  ...
                  System.out.println( nomejogador + " ... E o motivo que estou me entupindo de bebida e porque eu estou falido praticamente");   
                  System.out.println("Aperte enter para seguir\n"); 
                  try{System.in.read();}
                  catch(Exception e){}
                  ...
                  System.out.println( nomejogador + " ... Estava juntando umas pratas para abrir um negócio, contratei uma equipe    de goblins operários e construir minha fábrica de armadura e estava tudo indo bem, tinha meus funcionários e eu seria o gerente e cuidaria das finanças, porém deu tudo errado");
                  System.out.println("Aperte enter para seguir\n"); 
                  try{System.in.read();}
                  catch(Exception e){}
...
"                  --++++mmmmMMMMMMmmmmMMmm++++MMmm@@++::--::mmMM::@@++MMmm@@@@MM@@MM@@MMMMMMmmMMMM##@@MM@@MMMMMMMMMMMMMMMMmmmmmmmmmm++++::--..        \n"
 ...
 // chamando a variavel que  o jogador ira contar com a sorte
        ...
        static void casa2(int walk){
          ...
          System.out.println( nomejogador + " – você bem que poderia ficar calado.");
          System.out.println("Aperte enter para seguir\n"); 
          try{System.in.read();}
          catch(Exception e){}
          
          System.out.println("Jasquim – Mas olha elas são belas, será muito bom ter alguém assim para a minha loja de poções, porém ainda terei que ver os currículos delas, sabe quais são as informações mais importantes em um currículo?");
          System.out.println("Aperte enter para seguir\n"); 
          try{System.in.read();}
          catch(Exception e){}
